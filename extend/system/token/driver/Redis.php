...
namespace tyCore\token\driver;

use tyCore\token\Driver;
...
class Redis extends Driver
{
    ...
    public function __construct($options = [])
    {
        ...
        if ($this->options['persistent']) {
            $this->handler->pconnect($this->options['connection']['host'], $this->options['connection']['port'], $this->options['timeout'], 'persistent_id_' . $this->options['select']);
        } else {
            $this->handler->connect($this->options['connection']['host'], $this->options['connection']['port'], $this->options['timeout']);
        }

        if ('' != $this->options['connection']['password']) {
            $this->handler->auth($this->options['connection']['password']);
        }
